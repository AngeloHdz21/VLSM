...
public class CalcularVLSM extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<input type='hidden' name='ip' value='" + ip + "'>");
            out.println("<input type='hidden' name='prefix' value='" + prefijo + "'>");
            out.println("<input type='hidden' name='lanSizes' value='" + lanSizesRaw.replace("\n", " ").trim() + "'>");
